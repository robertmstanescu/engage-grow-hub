      ...
      <div className="relative z-10 px-8 lg:pl-24 pb-24 md:pb-32">
        <div className="max-w-[900px] mx-auto">
          <div className="flex items-center justify-center gap-4 mb-8">
            <button onClick={prev} className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-500 glass" style={{ color: "hsl(var(--pillar-primary))" }}>
            ...
            <button onClick={next} className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-500 glass" style={{ color: "hsl(var(--pillar-primary))" }}>
