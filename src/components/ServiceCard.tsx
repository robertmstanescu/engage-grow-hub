...
const ServiceCard = ({ tag, tagType, tagBgColor, tagTextColor, title, subtitle, description, deliverables, deliverablesLabel = "What's inside", price, time, note, compact }: ServiceCardProps) => {
  ...
  return (
    <motion.div
      ...
      <div className={compact ? "p-4 md:p-5 flex-shrink-0" : "p-5 md:p-6"}>
      ...
      {note && (
        <div className={`${compact ? "mx-4 md:mx-5 my-2" : "mx-5 md:mx-6 my-3"} px-3 py-2 rounded-lg flex-shrink-0`} style={{ backgroundColor: "hsl(var(--background) / 0.4)", borderLeft: "2px solid hsl(var(--accent) / 0.3)" }}>
