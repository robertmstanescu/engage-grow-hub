...
const PILLAR_COLOR_FIELDS = [
  ...
  { key: "color_carousel_btn_bg", label: "Carousel Button BG", description: "Background of carousel prev/next buttons", fallback: "#FFFFFF26" },
  { key: "color_carousel_btn_fg", label: "Carousel Button Icon", description: "Icon color of carousel prev/next buttons", fallback: "#FFFFFFE6" },
  { key: "color_dot_active", label: "Carousel Dot Active", description: "Active dot indicator color", fallback: "#E5C54F" },
  { key: "color_dot_inactive", label: "Carousel Dot Inactive", description: "Inactive dot indicator color", fallback: "#FFFFFF33" },
