...
const IntroStrip = () => {
  ...
  if (isLoading || !c.text) {
    return <div data-section="intro" aria-busy={isLoading} className="snap-section section-light relative py-row-fluid px-3" />;
  }

  return (
    <div data-section="intro" className="snap-section section-light relative py-row-fluid px-3">
      <div className="absolute inset-0 opacity-30 blur-[100px]" style={{ background: "radial-gradient(ellipse 80% 60% at 30% 70%, hsl(285 40% 92% / 0.8), transparent), radial-gradient(ellipse 60% 40% at 70% 30%, hsl(46 70% 88% / 0.6), transparent)" }} />
