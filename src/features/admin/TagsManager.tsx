            ...
            <div key={i} className="space-y-2 p-3 rounded-lg border mb-2" style={{ borderColor: "hsl(var(--border) / 0.5)" }}>
              ...
              <div className="flex items-center gap-3 pl-5 flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <input type="text" value={cat.bgColor || "#4D1B5E"} onChange={(e) => { const v = e.target.value; if (/^#[0-9A-Fa-f]{0,6}$/.test(v)) updateBlogCategory(i, "bgColor", v); }} placeholder="#HEX" className="w-20 px-2 py-1 rounded font-mono text-xs border" style={{ borderColor: "hsl(var(--border))", backgroundColor: "hsl(var(--card))", color: "hsl(var(--foreground))" }} />
                </div>
                <div className="flex items-center gap-1.5">
                  <label className="font-body text-[10px] uppercase tracking-wider text-muted-foreground">Text</label>
