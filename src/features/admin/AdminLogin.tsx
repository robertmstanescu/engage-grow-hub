      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="space-y-2">
          <button
            ...
            className="w-full font-display text-[11px] uppercase tracking-[0.08em] font-bold py-3 rounded-md border hover:opacity-85 transition-opacity flex items-center justify-center gap-2"
        ...
        <form onSubmit={handleMagicLink} className="space-y-3">
          ...
          <SpinnerButton
            ...
            icon={<Mail size={13} />}
            className="w-full font-display text-[11px] uppercase tracking-[0.08em] font-bold py-3.5 rounded-md hover:opacity-85 transition-opacity"
        ...
        {showPasswordFallback && (
          <form onSubmit={handlePassword} className="space-y-3 pt-4 border-t" style={{ borderColor: "hsl(var(--border))" }}>
            ...
            <SpinnerButton
              ...
              className="w-full font-display text-[10px] uppercase tracking-[0.08em] font-bold py-3 rounded-md border hover:opacity-85 transition-opacity"
