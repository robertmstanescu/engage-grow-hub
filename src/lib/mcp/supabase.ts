/**
 * Shared Supabase client factory for MCP tool handlers.
 *
 * Import-safe: no env reads at module top level — everything resolves lazily
 * inside the functions, which only run during an actual tool call.
 */
