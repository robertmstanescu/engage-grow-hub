...
2. **Make formatting reliable**
  ...
  - Ensure existing title HTML is parsed without losing legacy font, size, colour, or drop-cap-compatible markup. However, new pasted text should never copy the formatting of the text added from elsewhere and pasted.
3. **Verify every editor surface**
  ...
  - Test selection-based italic toggling, saving, reopening, HTML source editing for full rich text, and public rendering. Also test image adding, resizing, modifying shape, column adding, etc.
